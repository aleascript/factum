...
4. QUOI: Quelles sont les **menaces types** ? Quels sont les problèmes ou dangers usuels de cet univers ?
5. COMBIEN: Quelles sont les **ressources types** ? Qu'est ce qui a de la valeur dans cet univers ? (Pouvoir, groupe, économie, technologie, magie, etc...)
...
- il crée des lexiques de noms
- il réfléchit à étoffer les éléments du cadrage
- il peut utiliser l'aide de jeu sur le world building (qu'est ce qui rend intéressant...)
- il présente aux autres ce que tout le monde doit connaître
- il peut échanger des petits papiers avec Chaos
...
- on pioche 2 intrigues et en choisit 1 ou mixe les 2. 
...
* Posez des questions aux autres joueurs:
  * A Cosmos pour obtenir des éléments du monde
  * Aux Héros pour savoir ce qu’ils font ou ce qu’ils sont
  * A Chaos qui joue les seconds rôles de l’histoire
...
* Je propose des choix aux héros
  ...
  - corollaire : je fais sentir aux héros les conséquences de leurs
  choix
...
* Lors de la création des héros, j’indique les éléments importants à
  caractériser: culture, occupation, compétences, etc... en fonction du
  monde que vous voulez proposer.
...
* Je peux demander au Chaos de sonner la cavalerie
* Je redonne la main
