...
Difficulté à 3D qu'il faut vaincre.
S'il manque des éléments ça monte vite.
...
_Note: on peut (surtout en *solo* mais pas que) ne pas savoir à l'avance si un facteur est OK ou KO. Et donc ça permet d'envisager des 3/3. Très utile pour jouer une proposition crédible des joueurs sans pour autant la valider automatiquement. En effet, ce n'est pas parce que c'est crédible que c'est la vérité. Dans le cas d'une enquête, un échec pourrait alors signifier l'alibi du coupable proposé ou meme il pourrait etre la prochaine victime ce qui pourrait l'innocenter, etc..._
